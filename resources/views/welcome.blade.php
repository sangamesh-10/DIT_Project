...
<body>
    ...
    <div class="linkcontainer">
        <div class="iconcontainer">
            <a href="StudentLogin" ><img class='login-image' src="{{asset('images/studenticon.jpg')}}" alt="studenticon"></a>
            <p class="logincaption"><a href="StudentLogin">StudentLogin</a></p>
        </div>
        <div class="iconcontainer">
            <a href="FacultyLogin" ><img class="login-image" src="{{asset('images/facultyicon.jpg')}}" alt="teachericon"></a>
